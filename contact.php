...
<html>
    ...
    <div class="banner">
        <div class="detail">
            <h1>Наші контакти</h1>
            <p>Ми завжди раді вашим запитанням, пропозиціям та відгукам щодо роботи нашого кінотеатру</p>
    ...
    <div class="service">
        <div class="heading">
            <h1>Наш сервіс</h1>
            <p>Ми створюємо комфортні умови для кожного відвідувача та забезпечуємо якісний сервіс бронювання квитків онлайн</p>
        </div>
        <div class="box-container">
            <div class="box">
                ...
                <div>
                    ...
                    <p>У разі зміни планів ви можете швидко скасувати бронювання відповідно до умов сервісу без зайвих труднощів.</p>
                </div>
            </div>
            ...
            <div class="box">
                ...
                <div>
                    ...
                    <p>Ми гарантуємо чесні умови повернення коштів у випадку скасування сеансу або технічних проблем із бронюванням.</p>
                </div>
            </div>
            ...
            <div class="box">
                ...
                <div>
                    ...
                    <p>Наша служба підтримки працює цілодобово, щоб допомогти вам із будь-якими питаннями щодо квитків та сеансів.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="contact">
        <div class="heading">
            <h1>Зв'яжіться</h1>
            <p>Маєте запитання або пропозиції? Напишіть нам, і ми обов’язково допоможемо вам у найкоротший термін.</p>
        </div>
        <div class="box-container">
    ...
    <div class="address">
        <div class="heading">
            ...
            <p>Оберіть зручний спосіб зв’язку — ми завжди відкриті для спілкування та готові допомогти вам.</p>
        </div>
        <div class="box-container">
            <div class="box">
