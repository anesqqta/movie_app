...
<html>
    ...
    <div class="show-container">
        ...
        <?php
            $select_show = $conn->prepare("SELECT shows.*, halls.name, halls.city, halls.location FROM shows JOIN halls ON shows.hall_id = halls.id WHERE shows.movie_id = ? AND shows.show_time = ? AND shows.show_date = ? AND halls.status = ?");
