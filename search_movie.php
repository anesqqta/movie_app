...
<html>
    ...
    <div class="show-movie">
        ...
        <div class="box-container">
            <?php
                if (isset($_POST['search_movie']) or isset($_POST['search_movie_btn'])){
                    $search_movies = $_POST['search_movie'];
                    $select_movies = $conn->prepare("SELECT * FROM movies WHERE title LIKE '%{$search_movies}%' AND status = ?");
