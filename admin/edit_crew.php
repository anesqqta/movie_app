<?php
    ...
    if (isset($_POST['edit_crew'])) {
        ...
        $crew_role = filter_var($_POST['role'], FILTER_SANITIZE_STRING);
        $crew_bio = filter_var($_POST['bio'], FILTER_SANITIZE_STRING);
        ...
        $update_crew->execute([$crew_name, $crew_role, $crew_bio, $rename, $edit_id]);

        $success_msg[] = 'Члена знімальної групи оновлено!';
    }
...
<div class="form-container">
    <form action="" method="post" enctype="multipart/form-data" class="login">
        <h3>Редагувати члена знімальної групи</h3>
        <div class="img-box">
            <img src="../uploaded_files/actors/<?= $fetch_edit['image']; ?>">
        </div>
        <div class="input-field">
            <p>Ім'я члена знімальної групи <span>*</span></p>
            <input type="text" name="crew_name" maxlength="50" value="<?= $fetch_edit['name']; ?>" class="box" required>
        </div>
        <div class="input-field">
            <p>Посада члена знімальної групи <span>*</span></p>
            <input type="text" name="role" maxlength="50" value="<?= $fetch_edit['role']; ?>" class="box" required>
        </div>
        <div class="input-field">
            <p>Біографія члена знімальної групи <span>*</span></p>
            <textarea name="bio" required class="box" style="height: 10rem;"><?= $fetch_edit['bio']; ?></textarea>
        </div>
        <div class="input-field">
            <p>Фото члена знімальної групи</p>
            <input type="file" name="image" accept="image/*" class="box">
        </div>
        <div class="flex-btn">
            <button type="submit" name="edit_crew" class="btn">Зберегти зміни</button>
            <a href="view_crew.php" class="btn">Повернутись назад</a>
        </div>
    </form>
</div>
